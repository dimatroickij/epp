...
number_epp = ['91']
url = 'mass-media/news/archive?p_p_id=FeedsPortlet_INSTANCE_vwLQqFeTXiFo&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_FeedsPortlet_INSTANCE_vwLQqFeTXiFo_delta=10&_FeedsPortlet_INSTANCE_vwLQqFeTXiFo_resetCur=false&_FeedsPortlet_INSTANCE_vwLQqFeTXiFo_cur='
month = {}
month['июня'] = '06'
month['июля'] = '07'
month['мая'] = '05'
