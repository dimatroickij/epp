...
number_epp = ['73']
url = 'mass-media/news/archive?p_p_id=FeedsPortlet_INSTANCE_evV8VjXnatoM&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_FeedsPortlet_INSTANCE_evV8VjXnatoM_delta=10&_FeedsPortlet_INSTANCE_evV8VjXnatoM_resetCur=false&_FeedsPortlet_INSTANCE_evV8VjXnatoM_cur='
month = {}
month['июня'] = '06'
month['июля'] = '07'
month['мая'] = '05'
