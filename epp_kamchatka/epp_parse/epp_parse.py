...
for num_proc in tqdm(number_epp):
    ...
    mass_date = []
    numberOfPageNews = 1
    path_news = 'mass-media/news/archive?p_p_id=FeedsPortlet_INSTANCE_bRqGzSjhYRIH&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_FeedsPortlet_INSTANCE_bRqGzSjhYRIH_delta=10&_FeedsPortlet_INSTANCE_bRqGzSjhYRIH_resetCur=false&_FeedsPortlet_INSTANCE_bRqGzSjhYRIH_cur=' + str(numberOfPageNews)
