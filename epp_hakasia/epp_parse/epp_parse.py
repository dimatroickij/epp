...
number_epp = ['19']
url = 'mass-media/news?p_p_id=FeedsPortlet_INSTANCE_kBSdwtvvkLuK&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_FeedsPortlet_INSTANCE_kBSdwtvvkLuK_delta=10&_FeedsPortlet_INSTANCE_kBSdwtvvkLuK_resetCur=false&_FeedsPortlet_INSTANCE_kBSdwtvvkLuK_cur='
month = {}
month['июня'] = '06'
month['июля'] = '07'
month['мая'] = '05'
