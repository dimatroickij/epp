...
number_epp = ['01']
url = 'mass-media/news/archive?p_p_id=FeedsPortlet_INSTANCE_unBtEfDxXEcQ&p_p_lifecycle=0&p_p_state=normal&p_p_mode=view&_FeedsPortlet_INSTANCE_unBtEfDxXEcQ_delta=10&_FeedsPortlet_INSTANCE_unBtEfDxXEcQ_resetCur=false&_FeedsPortlet_INSTANCE_unBtEfDxXEcQ_cur='
month = {}
month['июня'] = '06'
month['июля'] = '07'
month['мая'] = '05'
